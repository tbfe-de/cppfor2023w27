...
int main()
{
    ...
    assert(oss.str() == "0:00.0");
    oss.str("");

    tc.set(1234);
    oss << tc;
    assert(oss.str() == "2:03.4");
    oss.str("");

    tc.set(1);
    oss << tc;
    assert(oss.str() == "0:00.1");
    oss.str("");

    tc.set(9);
    oss << tc;
    assert(oss.str() == "0:00.9");
    oss.str("");

    tc.set(10);
    oss << tc;
    assert(oss.str() == "0:01.0");
    oss.str("");

    tc.set(11);
    oss << tc;
    assert(oss.str() == "0:01.1");
    oss.str("");

    tc.set(599);
    oss << tc;
    assert(oss.str() == "0:59.9");
    oss.str("");

    tc.set(600);
    oss << tc;
    assert(oss.str() == "1:00.0");
    oss.str("");

    tc.set(601);
    oss << tc;
    assert(oss.str() == "1:00.1");
    oss.str("");

    tc.set(1200);
    oss << tc;
    assert(oss.str() == "2:00.0");
    oss.str("");

    tc.set(1201);
    oss << tc;
    assert(oss.str() == "2:00.1");
    oss.str("");
